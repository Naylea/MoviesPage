...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2019 a las 06:44:12
...
CREATE TABLE `peliculas` (
  ...
  `Pelicula` varchar(100) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
...
(1, 'Schindler\'s List(La lista de Schindler)', 'El industrialista aleman Oskar Schindler (Liam Neeson) urde un plan con su contador (Ben Kingsley) para rescatar prisioneros judios de los nazis.', 'La Lista de Schindler combina el horror abyecto del Holocausto con el caracteristico humanismo de Steven Spielberg para crear la obra maestra dramatica del director.', '', 'listaschindler.jpg'),
